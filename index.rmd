...
- Satellites with a very narrow application are also valuable (when compared to the much more widely used ones)
- Allows for much more detailed and targeted studies, but also requires a lot more technical knowledge for how to interpret and apply the data
- Is there a link between the complexity of satellite imagery and its accessibility? It seems like open-access imagery is often a bit more intuitive and easy to interpret, while commercial imagery is much more complex and usually limited to the use of professionals with technical expertise
